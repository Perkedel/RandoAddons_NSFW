...
- [Bob's guide on how to port Playermodel from Source1 to s&box-Source2!!](https://steamcommunity.com/sharedfiles/filedetails/?id=3665997623).
  - [New fork of Model Porter](https://github.com/BobmacU/CustomModel-2-Sbox). Original by Noztik.
  - Optionals
    - [Extract Unitypackage!](https://github.com/HakuSystems/EasyExtractUnitypackage)
...
We are not sure where to put these all, our chrome tabs are accumulating!, but we also hate to lose it
